...
\begin{document}
	...
	\begin{figure}
		\centering
		\includegraphics[width=\columnwidth]{images/depan}
	\end{figure}
	...
	\chapter{Informasi Keselamatan}\label{chap:2}
		...
		\begin{table}
			...
			\label{tab:2.2}
			\begin{tabular}{| p{0.4\linewidth} | p{0.2\linewidth}| p{0.6\linewidth}|}
				\hline
				...
				\hline
				\includegraphics[width=0.4\textwidth]{images/manual} & Panel Belakang & Informasi panduan singkat\\
				\hline
			\end{tabular}
		\end{table}
...
%	\newpage
	...
	\chapter{Petunjuk Pembersihan, Sterilisasi, dan Disinfeksi}
		...
		Pembersihan aksesoris perlu merujuk pada petunjuk yang diberikan oleh manufaktur aksesoris. Instruksi pembersihan pada aksesoris yang diberikan satu paket dengan penjualan perangkat adalah sebagai berikut.
		\begin{itemize}
			\item a
			\item a
		\end{itemize} 
